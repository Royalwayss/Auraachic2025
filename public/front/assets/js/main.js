...
(function ($) {
 ...
 $(document).on('shown.bs.modal','#quickview-modal',function(e){ 
	common_sliders(); 
	$('.qv-large-slider').slick({setPosition: true, });
	$('.qv-thumb-slider').slick({setPosition: true, });
 });
 $('.common-slider').each(function () {
  ...
  $(document).on('click','.product_quantity .qty-btn',function(){
