          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                ...
                @endif
                <form name="brandForm" id="brandForm" action="@if(empty($brand['id'])) {{ route('brands.store') }} @else {{ route('brands.update', $brand['id']) }} @endif" method="post" enctype="multipart/form-data">@csrf
                  @if(!empty($brand['id']))
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    @if(!empty($brand['brand_image']))
                      ...
                      <a style='color:#3f6ed3;' class="confirmDelete" title="Delete Brand Image" href="javascript:void(0)" record="brand-image" recordid="{{ $brand['id'] }}"><i style="color:#3F6ED3" class="fas fa-trash"></i></a>
                    @endif
                  </div>
                  <!-- <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    <label for="meta_description col-md-6">Meta Description</label>
                  ...
                  <div class="form-group col-md-6">
                    <label for="meta_keywords col-md-6">Meta Keywords</label>
