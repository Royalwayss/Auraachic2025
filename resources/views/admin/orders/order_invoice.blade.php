    ...
    <body>
        ...
        <div style="max-width: 780px; text-align: center; float: none; display: inline-block; width: 780px;">
            <table width="778px" class="InvoiceTable" border="0" cellspacing="0" cellpadding="0" style="text-align: left;">
                <tr>
                  <td colspan="3" align="center"><h2 style="height: 10px;">Order Invoice #{{$orderDetails['id'] }}</h2></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <p>{{ $web_settings['invoice_address'] }}</p>
                        <p><strong>{{config('constants.invoice_name')}}</strong></p>
                        <!-- <p>GST Number: {{config('constants.gst')}} </p> -->
                    </td>
                    <td>
                        <p>Contact No. : +{{ $web_settings['invoice_mobile'] }}</p>
                        <p>Email: {{ $web_settings['invoice_email'] }}</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                            ...
                            <tbody>
                                ...
                                @foreach($orderDetails['order_products'] as $product)
                                    <tr style="border-bottom: 1px solid #ddd;">
                                        <td>
                                            <p style="color: #8B9931; font-weight: bold; font-size: 14px;">{{$product['product_name']}} ({{$product['product_code']}})</p>
                                        </td>
                                        <td>
                                ...
                                <tr style="border-bottom: 1px solid #ddd;">
                                    <td colspan="4"></td>
                                    <td colspan="2" colspan="2">Shipping Charges (+):</td>
                                ...
                                <tr style="border-bottom: 1px solid #ddd;">
                                    <td colspan="4"></td>
                                    <td colspan="2">Taxes (Inclusive):</td>
