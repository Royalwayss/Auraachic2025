...
@section('content')
<style>.error_message{ color:red; }.mt-30{ margin-top:30px; }</style>
                  ...
                  <div class="card-body">
                     <table class="table table-bordered">
                        <tbody>
                           <tr>
                              <td colspan=2>
                                 <form action="{{ url('admin/update-order-status') }}" method="post" onsubmit="return updateOrderStatus()">
                                    @csrf
									...
									<div class="row mt-30" >
									   ...
									   <div class="form-group" style="width:100%">
                                          <label class="col-md-12 control-label">Current Status :</label> &nbsp;&nbsp;&nbsp;{{ $orderDetails['order_status'] }}
                                       ...
                                       <div class="form-group" style="width:100%">
                                          <label class="col-md-12 control-label">Update Status<span style="color:red">*<span></label>
                                          <div class="col-md-12">
										  <select name="order_status" id="order_status" class="form-control" required="">
												   <option>Select</option>
												   @foreach($getorderstatus as $status)
												   <option value="{{ $status['name'] }}"  @if(in_array($status['name'],$updated_order_status)) style="color:green" disabled @endif   >{{ $status['name'] }}</option>
												   @endforeach
                                            </select>
                                            </div>
                                       </div>
                                    ...
                                    &nbsp;&nbsp;
                                    <div class="row mt-30" id="Shipped-attr" style="display: none;">
                                       <div class="form-group">
                                          <label class=" control-label">Courier Name <span style="color:red">*<span></label>
                                          <div class="col-md-12">
                                             <input  class="form-control" type="text" name="delivery_method" @if(empty($orderDetails['delivery_method'])) id="delivery_method" @endif placeholder="Courier Name" value="{{ $orderDetails['delivery_method'] }}">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class=" control-label">Tracking (Reference) No.<span style="color:red">*<span></label>
                                          <div class="col-md-12">
                                             <input  class="form-control" type="text" name="awb_number" @if(empty($orderDetails['awb_number'])) id="awb_number" @endif placeholder="Tracking (Reference) No." value="{{ $orderDetails['awb_number'] }}">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="row mt-30" id="pickrr-attribute" style="display: none;">
                                       <div class="form-group">
                                          <label class=" control-label">Weight <span style="color:red">*<span></label>
                                          <div class="col-md-12">
                                             <input type="text" name="weight" id="weight" placeholder="Enter the Weight"  class="weight form-control">
                                             <p class="error_message" id="err-weight"> </p>
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label">Length <span style="color:red">*<span></label>
                                          <div class="col-md-12">
                                             <input type="text" name="length" id="length" placeholder="Enter the Length" class="length form-control">
                                             <p class="error_message" id="err-length"> </p>
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class=" control-label">Width <span style="color:red">*<span></label>
                                          <div class="col-md-12">
                                             <input type="text" name="width" id="width" placeholder="Enter the Width" class="width form-control">
                                             <p class="error_message" id="err-width"> </p>
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class=" control-label">Height <span style="color:red">*<span></label>
                                          <div class="col-md-12">
                                             <input type="text" name="height" id="height" placeholder="Enter the Height" class="height form-control">
                                             <p class="error_message" id="err-height"> </p>
                                          </div>
                                       </div>
                                    </div>
									<div class="row ">
                                    <button class="btn btn-primary btn-animated-link" type="submit">Update</button>
                                    </div>
