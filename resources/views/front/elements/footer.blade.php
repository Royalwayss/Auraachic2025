                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                ...
                                <li class="footer-menu-item"><a @if(Auth::check())
                                        href="{{ route('account',['profile']) }}" @else href="{{ route('signin') }}"
                                        @endif>My Account</a></li>
                                <li class="footer-menu-item"><a href="{{ route('account',['wishlist']) }}">Wishlist</a>
                                </li>
                                <li class="footer-menu-item"><a @if(Auth::check())
                                        href="{{ route('account',['orders']) }}" @else href="{{ route('signin') }}"
                                        @endif>My Orders</a></li>
                                <!-- <li class="footer-menu-item"><a href="javascript:;">My Account</a></li>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                ...
                                <li class="footer-menu-item">
                                    <a href="tel:+918010408050">
                                        <i class="fa-solid fa-phone me-2"></i> +91 80104 08050
                                    </a>
                                </li>
                                <li class="footer-menu-item d-flex social">
                                    <a href="https://www.instagram.com/auraachic_in/" target="_blank"><i
                                            class="fa-brands fa-instagram"></i></a>
                                    <a href="https://www.facebook.com/Auraachicofficial/" target="_blank"><i
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <div class="footer-newsletter">
                                <p class="footer-text mb-3">Join our fashion circle and be the first to know about
                                    exclusive drops!</p>
                                <div class="newsletter-wrapper">
                                    <form action="javascript:;" data-action="{{ route('addsubscriber') }}"
                                        id="newsletter-form" class="footer-newsletter-form d-flex align-items-center">
                                        <input class="footer-newsletter-input bg-transparent" type="text"
                                            placeholder="Your e-mail" autocomplete="off" id="newsletter-email">
                                        <button class="footer-newsletter-btn newsletter-btn-white newsletter-submit-btn"
