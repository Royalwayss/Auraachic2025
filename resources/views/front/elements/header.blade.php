      ...
      <div class="row align-items-center justify-content-between">
         <div class="col-lg-3 d-lg-block d-none">
            <div class="announcement-call-wrapper">
               <div class="announcement-call">
                  <a class="announcement-text text-white" href="tel:+91-8010408050">Call: +91
                  8010408050</a>
               </div>
            </div>
         </div>
         <div class="col-lg-6 col-12">
            <div class="announcement-text-wrapper d-flex align-items-center justify-content-center">
               <p class="announcement-text text-white">New here? Get extra 10% OFF with code WELCOME10 🎉</p>
            </div>
         </div>
         <div class="col-lg-3 d-lg-block d-none">
         ...
         <div class="row align-items-center">
            ...
            <div class="col-lg-3 col-md-8 col-8">
               <div class="header-action d-flex align-items-center justify-content-end">
                  ...
                  <a class="header-action-item header-wishlist ms-4  d-sm-block d-none"  @if(Auth::check()) href="{{ route('account',['wishlist']) }}" @else href="{{ route('signin') }}" @endif>
                  ...
                  <a class="header-action-item header-login ms-4  d-sm-none d-block"  @if(Auth::check()) href="{{ route('account',['profile']) }}" @else href="{{ route('signin') }}" @endif><i
