...
<div class="pagination justify-content-center">
   <nav> 
      <ul class="pagination m-0 d-flex align-items-center">
		 ...
		 @if($pagination_link['label'] == '&laquo; Previous' && $pagination_link['url'] != '')
         ...
         <li class="item @if($pagination_link['active'] =='1') active disabled @endif" ><a class="link @if($pagination_link['active'] =='1') disabled-link @endif" @if($pagination_link['active'] =='1')  href="javascript:void(0)" @else href="{{ $pagination_link['url'] }}" @endif>{{ $pagination_link['label'] }}</a></li>
         @endif
		
		 @if($pagination_link['label'] == 'Next &raquo;' && $pagination_link['url'] != '')
         <li class="item">
            <a class="link" href="{{ $pagination_link['url'] }}">
               <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
