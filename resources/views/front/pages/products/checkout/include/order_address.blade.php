...
<div class="row">
    <div class="col-lg-6 col-md-12 col-12">
        <div class="addressHead">
            ...
            <a href="javascript:;" class="button2 orderAddress" data-type="shipping" data-id="">Add</a>
        </div>
        @foreach($shipping_addresses as $shipping_address)
        <div class="checkout-user-area overflow-hidden d-flex">
            <label class="checkout-lable">
                <input type="radio" @if($shipping_address['is_default']=='1' ) checked="checked" @endif
                    name="default_shipping_address" value="{{ $shipping_address['id'] }}">
            ...
            <div class="checkout-user-details d-flex align-items-center justify-content-between w-100">
                ...
                <div class="btn-groups">
                    <a href="javascript:;" class="edit-user btn-secondary orderAddress" data-type="shipping"
                        data-id="{{ $shipping_address['id'] }}">Edit</a>
                    @if($shipping_address['is_default'] != '1')
                    <a href="javascript:;" data-id="{{ $shipping_address['id'] }}"
                        class="edit-user deleteaddress btn-secondary">Remove</a>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-6 col-md-12 col-12">
        <div class="addressHead mtResp">
            <h2 class="shipping-address-heading pb-1"><strong>Billing Address</strong></h2>
            @if(empty($billing_addresses))
            <a href="javascript:;" class="button2 orderAddress" data-type="billing" data-id="">Add</a>
            @endif
        ...
        <div class="checkout-user-area overflow-hidden d-flex">
            ...
            <div class="checkout-user-details d-flex align-items-center justify-content-between w-100">
                ...
                <div class="btn-groups">
                    <a href="javascript:;" class="edit-user btn-secondary orderAddress" data-type="billing"
                        data-id="{{ $billing_addresses['id'] }}">Edit</a>
                </div>
            </div>
        </div>
        @endif
