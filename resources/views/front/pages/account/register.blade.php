...
<main id="MainContent" class="content-for-layout">
    <div class="login-page login-page mt-5 mb-5">
        <div class="container">
            <div class="form-bg">
                <form action="javascript:;" data-action="{{ route('signup') }}" id="signup-form"
                    class="login-form common-form mx-auto">@csrf
                        ...
                        <div class="col-12 otp">
                            <fieldset>
                                ...
                                <div class="d-flex">
                                    ...
                                    <button type="submit" id="sendOtpBtn" class="btn-signin w-20"
                                        data-action="send_otp">Send OTP</button>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a href="{{ route('signin') }}" class="btn-secondary mt-2 btn-register">Already have a account?
                                <span style="color:#d3b696; padding-left:5px;"> Login</span></a>
                        </div>
                    </div>
                </form>
            </div>
